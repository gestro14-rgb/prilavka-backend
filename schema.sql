...
-- Пользователи (для реферальной программы и программы лояльности)
-- Создаётся лениво при первом обращении к профилю / статистике.
...
-- Лог начислений баллов за рефералов.
-- Уникальность по order_id исключает двойное начисление при повторной смене статуса.
